...
public class TransportService {
	...
	/** 通过QQ邮箱发送邮件 */
	public static boolean sendMailBySMTP(Email email) throws AddressException, MessagingException,
		 ...
		 */
		message.setHeader(	MimeUtility.encodeText(email.getSubject(), "UTF-8", "B"),
